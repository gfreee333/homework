...
public class SomeStringTest {
    ...
    @Test
    public void testArrayStringOreString() {
        String[] str = new String[]{"hello", "hello", "world", "yes", "hello"};
        assertEquals(SomeString.arrayStringOreString(str), "hello, hello, world, yes, hello");
    }
}